const Root = () => {
  return (
    <div>
      <main className="min-h-[100vh] lg:flex lg:flex-col">
        <div className="p-4 lg:flex-1 lg:flex lg:items-center">
          <div className="flex flex-col p-5 lg:flex-row md:max-w-[568px] md:mx-auto lg:min-w-full lg:items-center">
            <div className="lg:flex-1 flex lg:justify-center">
              <img
                className="w-[57px] h-[45px] lg:h-[380px] lg:w-[380px]"
                src="/logo.svg"
                alt="x-logo"
              />
            </div>
        ...
        <div>
          <nav>
            <ul className="flex justify-center gap-2 flex-wrap py-3 px-4 text-[rgb(83,100,113)] text-[13px]">
              <li>About</li>
